...
/**
 * Built on @radix-ui/react-tooltip. `TooltipProvider` is intentionally
 * exported separately rather than wrapped inside `Tooltip` itself — mount
 * one `TooltipProvider` per screen (features/layout/components/app-shell.tsx
 * does this) so adjacent tooltips share hover-delay grouping instead of
 * each re-triggering the full delay.
 */
